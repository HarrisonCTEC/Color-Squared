...
public class Tiles {
	 ...
	 */
	public static int randomColor, randomNumber;
	 ...
	 * 
	 * @param someColor
	 *            the Color that we are questioning if it has been used aldready or not.
	...
	/**
	 * When a color is being used, this method updates the boolean array Every color that the game uses has a number assoisated to it, but is not ever formely used in code
	 */
	...
	/**
	 * This allows the computer to know what tile is special as well the color of that tile. This prevents duplicate tile colors
	 * 
	 * @param hotButton
	 *            the int that was randomly created at the game screen activity
	 * @param currentColor
	 ...
	 * 
	 * @param currentColor
	 *            the color we are currently at so we know not to generate it, it is also the color of the hotButton
